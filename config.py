...
#
__C.CONST                                   = edict()
__C.CONST.DEVICE                            = None
__C.CONST.RNG_SEED                          = 0
__C.CONST.IMG_W                             = 224       # Image width for input
__C.CONST.IMG_H                             = 224       # Image height for input
__C.CONST.N_VOX                             = 32
__C.CONST.BATCH_SIZE                        = 1
__C.CONST.N_VIEWS_RENDERING                 = 1         # Dummy property for Pascal 3D ##STEPS
__C.CONST.CROP_IMG_W                        = 128       # Dummy property for Pascal 3D
__C.CONST.CROP_IMG_H                        = 128       # Dummy property for Pascal 3D
# __C.CONST.WEIGHTS                           = '/cluster/51/tt/proj/output/checkpoints/2022-07-16T10:27:51.750871/ckpt-epoch-0550.pth' ##STEPS
...
#
__C.TRAIN                                   = edict()
__C.TRAIN.RESUME_TRAIN                      = False ##STEPS
__C.TRAIN.NUM_WORKER                        = 4             # number of data workers
__C.TRAIN.NUM_EPOCHES                       = 250 ##STEPS
...
__C.TRAIN.UPDATE_N_VIEWS_RENDERING          = False ##STEPS
