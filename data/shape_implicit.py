...
class ShapeImplicit(torch.utils.data.Dataset):
    ...
    def get_sdf_samples(self, path_to_sdf):
        ...
        pos_ran = torch.randint(0, pos_tensor.shape[0], (self.num_sample_points//2, ))
        pos_ind = pos_tensor[pos_ran]
        neg_ran = torch.randint(0, neg_tensor.shape[0], (self.num_sample_points - self.num_sample_points//2,))
        neg_ind = neg_tensor[neg_ran]

        return torch.vstack((pos_ind, neg_ind))
